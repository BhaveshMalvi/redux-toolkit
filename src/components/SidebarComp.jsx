...
function SidebarComp({ user }) {
  ...
  return (
    ...
    <div style={{ display: "flex", height: "100vh", zIndex: "2", justifyContent: "start", alignItems: "center", borderRadius: "0px 40px 40px 0px", overflow: "hidden", width:"20rem" }}>
            ...
            <>
              ...
              >
                ...
                <Menu style={{ fontSize: "1.5rem", padding: "10px" }}>
                  ...
                  <MenuItem className="menubar" onClick={() => signOut.handlesignOut(navigate("/signin"), logOut()  )}>Sign-out</MenuItem>
                </Menu>
              </Sidebar>
            </>
          )}
