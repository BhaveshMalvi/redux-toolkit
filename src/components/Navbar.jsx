...
const Navbar = () => {
    ...
    return (
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderRadius: "5px", background: "#dadee8", padding: "0 10px 0 10px", position: "sticky", top: "0px", boxShadow: "10px 10px 15px #4d2c81", zIndex:"1" }}>
            ...
            <div style={{ display: "flex", justifyContent: "end", width: "70%", alignItems: "center", padding: "10px 0 10px 0" }}>
                ...
                <Link className='navLink' to='/cart'><h2 style={{display:"flex"}}>Cart <span className='cartCount' style={{marginLeft:"10px"}}>
                    <span style={{ marginLeft: "7px", color: "red", position: "absolute", top: "0", right: "10px" }}><h6>{productCount.length} </h6> </span>
